...
import { R5_ClaimResponse_SubDetail1 } from './R5_ClaimResponse_SubDetail1'
import { R5_CodeableConcept } from './R5_CodeableConcept'
import { R5_DomainResource } from './R5_DomainResource'
import { R5_Money } from './R5_Money'
import { R5_Quantity } from './R5_Quantity'

export class R5_ClaimResponse_Detail1      extends R5_BackboneElement
{
   ...
   subDetail : R5_ClaimResponse_SubDetail1 [];
}
