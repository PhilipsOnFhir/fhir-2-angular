...
import { R5_ExplanationOfBenefit_Detail1 } from './R5_ExplanationOfBenefit_Detail1'
import { R5_Money } from './R5_Money'
import { R5_Period } from './R5_Period'
import { R5_Quantity } from './R5_Quantity'
import { R5_Reference } from './R5_Reference'

export class R5_ExplanationOfBenefit_AddItem      extends R5_BackboneElement
{
   ...
   detail : R5_ExplanationOfBenefit_Detail1 [];
}
