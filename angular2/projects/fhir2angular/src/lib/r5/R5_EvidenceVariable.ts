...
import { R5_EvidenceVariableTypeEnum } from './R5_EvidenceVariableTypeEnum'
import { R5_EvidenceVariable_Characteristic } from './R5_EvidenceVariable_Characteristic'
...
export class R5_EvidenceVariable      extends R5_DomainResource
{
   ...
   type : R5_EvidenceVariableTypeEnum ;
   characteristic : R5_EvidenceVariable_Characteristic [];
}
