...
import { R5_ResearchElementDefinition_Characteristic } from './R5_ResearchElementDefinition_Characteristic'
import { R5_ResearchElementTypeEnum } from './R5_ResearchElementTypeEnum'
import { R5_UsageContext } from './R5_UsageContext'
import { R5_VariableTypeEnum } from './R5_VariableTypeEnum'

export class R5_ResearchElementDefinition      extends R5_DomainResource
{
   ...
   library : string [];
   type : R5_ResearchElementTypeEnum ;
   variableType : R5_VariableTypeEnum ;
   characteristic : R5_ResearchElementDefinition_Characteristic [];
}
