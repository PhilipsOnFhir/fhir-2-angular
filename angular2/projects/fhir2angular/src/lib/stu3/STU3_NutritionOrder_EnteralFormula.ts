...
import { STU3_NutritionOrder_Administration } from './STU3_NutritionOrder_Administration'
import { STU3_Quantity } from './STU3_Quantity'

export class STU3_NutritionOrder_EnteralFormula      extends STU3_BackboneElement
{
   ...
   administration : STU3_NutritionOrder_Administration [];
