...
import { R4_1_ExplanationOfBenefit_Detail1 } from './R4_1_ExplanationOfBenefit_Detail1'
import { R4_1_Money } from './R4_1_Money'
import { R4_1_Period } from './R4_1_Period'
import { R4_1_Quantity } from './R4_1_Quantity'
import { R4_1_Reference } from './R4_1_Reference'

export class R4_1_ExplanationOfBenefit_AddItem      extends R4_1_BackboneElement
{
   ...
   detail : R4_1_ExplanationOfBenefit_Detail1 [];
}
