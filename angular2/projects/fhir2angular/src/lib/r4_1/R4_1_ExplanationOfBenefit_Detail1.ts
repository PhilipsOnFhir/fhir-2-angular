...
import { R4_1_ExplanationOfBenefit_SubDetail1 } from './R4_1_ExplanationOfBenefit_SubDetail1'
import { R4_1_Money } from './R4_1_Money'
import { R4_1_Quantity } from './R4_1_Quantity'

export class R4_1_ExplanationOfBenefit_Detail1      extends R4_1_BackboneElement
{
   ...
   subDetail : R4_1_ExplanationOfBenefit_SubDetail1 [];
}
