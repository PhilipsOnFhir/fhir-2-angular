...
import { R4_1_ExplanationOfBenefit_SubDetail } from './R4_1_ExplanationOfBenefit_SubDetail'
import { R4_1_Money } from './R4_1_Money'
import { R4_1_Quantity } from './R4_1_Quantity'
import { R4_1_Reference } from './R4_1_Reference'

export class R4_1_ExplanationOfBenefit_Detail      extends R4_1_BackboneElement
{
   ...
   subDetail : R4_1_ExplanationOfBenefit_SubDetail [];
}
