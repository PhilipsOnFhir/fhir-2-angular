...
import { R4_ExplanationOfBenefit_Detail } from './R4_ExplanationOfBenefit_Detail'
import { R4_Money } from './R4_Money'
import { R4_Period } from './R4_Period'
import { R4_Quantity } from './R4_Quantity'
import { R4_Reference } from './R4_Reference'

export class R4_ExplanationOfBenefit_Item      extends R4_BackboneElement
{
   ...
   detail : R4_ExplanationOfBenefit_Detail [];
}
