...
import { R4_ClaimResponse_Detail1 } from './R4_ClaimResponse_Detail1'
...
export class R4_ClaimResponse_AddItem      extends R4_BackboneElement
{
   ...
   detail : R4_ClaimResponse_Detail1 [];
}
